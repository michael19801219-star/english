      ...
      <div className="fixed bottom-10 left-0 right-0 flex justify-center z-[400] pointer-events-none px-6">
        <div className="pointer-events-auto max-w-md w-full flex justify-center">
          {showFeedback ? (
            <button 
              onClick={handleNext} 
              className="px-10 py-5 bg-[#0f172a] text-white rounded-full text-[16px] font-black shadow-[0_25px_60px_rgba(0,0,0,0.4)] active:scale-95 transition-all flex items-center gap-3 border border-white/20 whitespace-nowrap animate-fadeIn"
            >
            ...
            <button 
              ...
              className={`px-12 py-5 rounded-full text-[16px] font-black shadow-[0_25px_60px_rgba(79,70,229,0.3)] transition-all border border-white/10 whitespace-nowrap ${selectedOption === null ? 'bg-gray-200 text-gray-400 opacity-50 shadow-none' : 'bg-indigo-600 text-white active:scale-95'}`}
            >
              确认提交
            </button>
          )}
              ...
              <div className="p-5 bg-white rounded-[28px] border border-gray-100 shadow-sm relative">
                <div className="flex justify-between items-center mb-3">
                  ...
                  <button 
                    ...
                    className={`px-3 py-1.5 rounded-xl transition-all active:scale-90 text-[10px] font-black ${isSaved ? 'bg-amber-100 text-amber-600' : 'bg-gray-50 text-gray-300'}`}
                  >
                    {isSaved ? '★ 已收藏' : '☆ 收藏'}
                  </button>
                </div>
              ...
              <div className="p-5 bg-indigo-50/50 rounded-[32px] border border-indigo-100/50 flex flex-col backdrop-blur-sm">
                ...
                <div className="relative flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 py-3.5 px-5 bg-white rounded-[18px] border-none text-[13px] font-bold shadow-lg outline-none focus:ring-2 focus:ring-indigo-100"
                  />
